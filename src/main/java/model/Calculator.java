...
public class Calculator {
   ...
   /**
    * Function for adding {@code Operation} to history
    *
    * @param operation {@code Operation} object which will be added to list
    */
   ...
   /**
    * Function for adding {@code BigDecimal} to history
    *
    * @param value {@code BigDecimal} object which will be added to list
    */
   public void addToHistory(BigDecimal value) {
      history.add(value);
   }
    ...
    *
    * @return last element of {@code history} or null when {@code history} is empty
    */
    ...
    * @return {@code BigDecimal} result of operation
    * @throws ArithmeticException if divisor of operation is zero
    */
   private BigDecimal divide(BigDecimal currentValue, BigDecimal lastValue) throws DivisionByZeroException {
      ...
      return lastValue.divide(currentValue, MathContext.DECIMAL128);
        /*return lastValue.setScale(1000,RoundingMode.UNNECESSARY)
                .divide(currentValue.setScale(1000,RoundingMode.UNNECESSARY),BigDecimal.ROUND_HALF_EVEN);*/
   }
